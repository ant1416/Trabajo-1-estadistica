...
Para la hipótesis 2, se realizaron correlaciones de pearsons para analizar cómo se relacionan las variables con los diferentes tipos de sexismo. Partiendo por el sexismo benevolente, su relación con la variable de dominación grupal (sdo-d) nos indica una relación positiva entre sexismo benevolente y apoyo a dominación grupal(r = 0.157, p \< 0.001). En el caso de la meritocracia, esto se repite, contando con una dirección positiva al igual que el anterior. Esto sugiere que el sexismo benevolente no solo se vincula con actitudes explícitas de jerarquía social, sino también con creencias más sutiles que legitiman la desigualdad, como la meritocracia. Finalmente, no se observó una correlación significativa entre el sexismo benevolente y la oposición a la igualdad (r = -0.026, p = 0.134), lo que indica que no existe evidencia de una asociación entre ambas variables en la muestra analizada.

Con respecto al sexismo hostil, Se observó una correlación positiva y estadísticamente significativa entre el sexismo hostil y la dominación grupal (r = 0.310, p \< 0.001), lo que indica que mayores niveles de actitudes hostiles hacia las mujeres se asocian con un mayor apoyo a la jerarquía entre grupos. Esto, al igual que con sexismo benevolente, se repite con meritocracia,lo que indica que mayores niveles de actitudes hostiles hacia las mujeres se asocian con una mayor adhesión a explicaciones meritocráticas de las diferencias sociales. Finalmente, a diferencia con lo ocurrido con el sexismo benevolente, acá la relación entre sexismo hostil y oposición a la igualdad es positiva, lo que nos dice que las personas que más apoyan la desigualdad social tienden a mostrar más sexismo hostil, pero la relación es débil.
...
al aplicar el modelo de regresión lineal a el sexismo benevolente, descubrimos que el modelo explica solo un 3.85% de la variabilidad del sexismo benevolente ( R2: 0.0385), lo que nos dice que el fenómeno es mucho más complejo de lo que pensábamos inicialmente. los principales predictores positivos de esto  siendo edad (débil pero significativo), meritocracia (moderado) y principalmente dominancia social, siendo el predictor positivo más fuerte. sexo no es revelante en este caso, y nuestro unico predictor negativo seria oposicion a la igualdad (bajo pero significativo).

Al aplicar el modelo al sexismo hostil, en cambio, nos da un R2 de 0.117, lo que significa que el modelo explica un 11.7% de la variabilidad del sexismo hostil, que si bien sigue siendo bajo,  es más alto que el sexismo benevolente. Al igual que la vez anterior, el predictor de género no es relevante acá y la edad sigue siendo un predictor positivo pero más bajo que en sexismo benevolente. meritocracia y oposición a la igualdad son los 2 positivos, y el predictor más fuerte positivo es dominancia social, igual que en sexismo benevolente

Estos resultados nos dicen que el sexismo hostil se asocia de manera consistente con orientaciones ideológicas jerárquicas y anti igualitarias, mientras que el sexismo benevolente presenta una estructura más ambivalente, donde distintos componentes de la dominancia social se relacionan en direcciones opuestas. El sexismo hostil y benevolente son 2 tipos muy diferentes de sexismo, que funcionan con lógicas distintas, tal como vimos en los distintos resultados.
...
En conjunto, los resultados evidencian una tensión entre la adhesión declarada a principios igualitarios y la persistencia de formas de prejuicio de género, especialmente en su dimensión benevolente. Desde la perspectiva de la teoría SDO, esto sugiere que la legitimación de la desigualdad no se sostiene únicamente a través de actitudes explícitas de dominación, sino también mediante creencias culturalmente aceptadas que contribuyen a reproducir jerarquías de forma indirecta. Dado el carácter exploratorio del estudio y las limitaciones en la consistencia interna de algunas escalas, estos hallazgos deben interpretarse como tendencias que abren líneas para futuras investigaciones.
